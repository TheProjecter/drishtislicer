...
public:
    ...
    void setupUi(QWidget *RemapWidget)
    {
        ...
        colorList = new QComboBox(RemapWidget);
        colorList->setObjectName(QString::fromUtf8("colorList"));
        QSizePolicy sizePolicy1(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(colorList->sizePolicy().hasHeightForWidth());
        colorList->setSizePolicy(sizePolicy1);
        colorList->setMinimumSize(QSize(50, 20));
        colorList->setMaximumSize(QSize(100, 25));

        hboxLayout->addWidget(colorList);
        ...
        sizePolicy2.setHeightForWidth(colorFrame->sizePolicy().hasHeightForWidth());
        colorFrame->setSizePolicy(sizePolicy2);
        colorFrame->setMinimumSize(QSize(200, 30));
        colorFrame->setMaximumSize(QSize(16777215, 30));
        ...
        sizePolicy1.setHeightForWidth(sliderFrame->sizePolicy().hasHeightForWidth());
        sliderFrame->setSizePolicy(sizePolicy1);
    ...
    void retranslateUi(QWidget *RemapWidget)
    {
        ...
        colorList->insertItems(0, QStringList()
         << QApplication::translate("RemapWidget", "black-white", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("RemapWidget", "white-black", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("RemapWidget", "sepia-1", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("RemapWidget", "sepia-2", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("RemapWidget", "palegreen", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("RemapWidget", "violet", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("RemapWidget", "red", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("RemapWidget", "blue", 0, QApplication::UnicodeUTF8)
        );
