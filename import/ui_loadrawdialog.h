...
**
** Created: Mon 11. Jan 15:53:12 2010
...
public:
    ...
    void setupUi(QDialog *LoadRawDialog)
    {
        ...
        LoadRawDialog->setMaximumSize(QSize(375, 100));
    ...
    {
        LoadRawDialog->setWindowTitle(QApplication::translate("LoadRawDialog", "Load Raw", 0, QApplication::UnicodeUTF8));
