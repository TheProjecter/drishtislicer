...
QList<float> RawPlugin::rawMap() { return m_rawMap; }
QList<uchar> RawPlugin::pvlMap() { return m_pvlMap; }

void
RawPlugin::setMap(QList<float> rm,
		  QList<uchar> pm)
{
  m_rawMap = rm;
  m_pvlMap = pm;
...
QImage
RawPlugin::getDepthSliceImage(int slc)
{
  int nX, nY, nZ;
  nX = m_depth;
  nY = m_width;
...
QImage
RawPlugin::getWidthSliceImage(int slc)
{
  int nX, nY, nZ;
  nX = m_depth;
  nY = m_width;
...
QImage
RawPlugin::getHeightSliceImage(int slc)
{
  int nX, nY, nZ;
  nX = m_depth;
  nY = m_width;
